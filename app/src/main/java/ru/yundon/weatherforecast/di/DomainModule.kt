...
class DomainModule {
    ...
    @Provides
    fun provideGetCitiesWeatherListUseCase(repository: CitiesWeatherRepository): GetCitiesWeatherListUseCase {
        return GetCitiesWeatherListUseCase(citiesWeatherRepository = repository)
    }

    @Provides
    fun provideGetCityWeatherByNameUseCase(repository: CitiesWeatherRepository): GetCityWeatherByNameUseCase {
